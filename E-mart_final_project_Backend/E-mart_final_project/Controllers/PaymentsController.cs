...
namespace E_mart_final_project.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public PaymentsController(EmartContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Payment>> PostPayment(Payment payment)
        {
          if (_context.Payment == null)
          {
              return Problem("Entity set 'EmartContext.Payment'  is null.");
          }
        ...
        {
            return (_context.Payment?.Any(e => e.PayID == id)).GetValueOrDefault();
        }
    }
}
